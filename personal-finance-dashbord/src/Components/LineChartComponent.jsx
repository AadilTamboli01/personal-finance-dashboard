...
const LineChartComponent = ({ transactions }) => {
  ...
  // 🔥 Date ke bajaye MONTH se group karo
  const groupedData = {};
  ...
  return (
    <div className="bg-white dark:bg-gray-800 p-5 rounded-2xl shadow-lg h-full flex flex-col transition-colors duration-300">
